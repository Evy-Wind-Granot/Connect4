class ConnectFour:
    ...
    def print_board(self):
        ...
        print('  ' + col_numbers)
    #Add the piece if it can be inserted into the lowest place
    def add_piece(self, col, player):
        ...
        return False
    #checks if there are 4 of a kind vertically, horzontally or in either diagonal
